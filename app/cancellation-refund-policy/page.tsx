      ...
      <div className="min-h-screen bg-white pt-16 sm:pt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
          ...
          <div className="w-full">
            ...
            <div className="mt-12 pt-8 border-t" style={{ borderColor: '#e8edf4' }}>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-6" style={{ color: '#111822' }}>
                Post-Ticketing Service Fees
              </h2>
              <div 
                className="w-10 sm:w-12 h-0.5 sm:h-1 mb-6 rounded-full"
                style={{
                  background: `linear-gradient(to right, #111822, #4a7ab5)`
                }}
              />
